<div class="wrap">
    ...
    <form method="post" action="options.php" id="cf7_form_agile_settings"> 
        <?php settings_fields($this->tag . '-settings-group'); ?>
        <?php do_settings_sections($this->tag); ?>
        <?php wp_nonce_field('agilecrm_cf7_account_nonce_action','agilecrm_cf7_account_nonce_field'); ?>
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><label for="agilecrm_cf7_domain">Domain</label></th>
                <td>
                    <span style="padding:3px; margin:0px; border: 1px solid #dfdfdf; border-right: 0px; background-color:#eee;">https://</span>
                    <input type="text"  name="agilecrm_cf7_domain" id="agilecrm_cf7_domain" value="<?php echo get_option('agilecrm_cf7_domain'); ?>" style="width: 100px; margin: 0px; border-radius: 0px;" required="">
            ...
            <tr valign="top">
                <th scope="row"><label for="agilecrm_cf7_admin_email">Domain User</label></th>
                <td>
                    <input type="text" style="width:250px;" name="agilecrm_cf7_admin_email" id="agilecrm_cf7_admin_email" value="<?php echo get_option('agilecrm_cf7_admin_email'); ?>" placeholder="admin user email" required=""><br>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="agilecrm_cf7_api_key">API Key</label></th>
                <td>
                    <input type="text" style="width:250px;" name="agilecrm_cf7_api_key" id="agilecrm_cf7_api_key" value="<?php echo get_option('agilecrm_cf7_api_key'); ?>" placeholder="REST api key" required=""><br>
        ...
        <?php submit_button('Save Changes', 'primary', 'cf7_submit_button', false); ?>&nbsp;<span
